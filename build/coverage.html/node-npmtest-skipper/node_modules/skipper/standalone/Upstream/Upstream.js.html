...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-skipper/node_modules/skipper/standalone/Upstream/Upstream.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-skipper/node_modules/skipper/standalone/Upstream/Upstream.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-skipper/node_modules/skipper/standalone/Upstream/</a> &#187; Upstream.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function Upstream(opts) {</span>
...
&nbsp;
  // Track fatal errors.
<span class="cstat-no" title="statement not covered" >  this._fatalErrors = [];</span>
&nbsp;
  // Allow `noop` to be passed in to force this Upstream to immediately end.
<span class="cstat-no" title="statement not covered" >  if (opts.noop) <span class="cstat-no" title="statement not covered" >this.isNoop = true;</span></span>
&nbsp;
  // Keep track of file streams which we've emitted.
<span class="cstat-no" title="statement not covered" >  this._files = [];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  this.timeouts.untilFirstFileTimer = setTimeout(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    debug('maxTimeToWaitForFirstFile timer fired- as of now there are %d file uploads pending %s', self._files.length, self._files.length === 0 ? '' : '(so it\'s fine)');</span>
<span class="cstat-no" title="statement not covered" >    if (self._files.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      var e = new Error();</span>
<span class="cstat-no" title="statement not covered" >      e.code = 'ETIMEOUT';</span>
<span class="cstat-no" title="statement not covered" >      e.message =</span>
        e.code + ': ' +
...
<span class="cstat-no" title="statement not covered" >      self.fatalIncomingError(e);</span>
    }
  }, opts.maxTimeToWaitForFirstFile);
<span class="cstat-no" title="statement not covered" >  debug('Set up "maxTimeToWaitForFirstFile" timer for %dms', opts.maxTimeToWaitForFirstFile);</span>
&nbsp;
  ...
  // Sails, or MockReq)
<span class="cstat-no" title="statement not covered" >  this.timeouts.untilMaxBufferTimer = setTimeout(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    debug('maxTimeToBuffer timer fired- upstream is %s As of now there are %d file uploads', self._connected?'connected to a receiver (so we\'re good).':'NOT CONNECTED TO A RECEIVER!!',self._files.length);</span>
<span class="cstat-no" title="statement not covered" >    if (!self._connected) {</span>
<span class="cstat-no" title="statement not covered" >      var e = new Error();</span>
<span class="cstat-no" title="statement not covered" >      e.code = 'EMAXBUFFER';</span>
<span class="cstat-no" title="statement not covered" >      e.message =</span>
        e.code + ': ' +
