...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-skipper/node_modules/skipper/standalone/Upstream/prototype.fatalIncomingError.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-skipper/node_modules/skipper/standalone/Upstream/prototype.fatalIncomingError.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-skipper/node_modules/skipper/standalone/Upstream/</a> &#187; prototype.fatalIncomingError.js</div>
</div>
<div class="body">
 ...
 * @param  {Error} err
 */
module.exports = <span class="fstat-no" title="function not covered" >function fatalIncomingError (err) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  log.color('red').write('Fatal incoming error in Upstream `%s` ::   (source or user may have cancelled the request)',this.fieldName);</span>
<span class="cstat-no" title="statement not covered" >  log.color('red').write(err.toString &amp;&amp; err.toString());</span>
<span class="cstat-no" title="statement not covered" >  log.color('red').write('-----------');</span>
<span class="cstat-no" title="statement not covered" >  log(err.code);</span>
<span class="cstat-no" title="statement not covered" >  log('%s - %s', util.inspect(err.message), util.inspect(err.name));</span>
<span class="cstat-no" title="statement not covered" >  log.color('red').write('-----------');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  _.each(this._files, <span class="fstat-no" title="function not covered" >function(file) {</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (file.status === 'cancelled') {</span>
<span class="cstat-no" title="statement not covered" >      debug('Swallowing fatal upstream error for already-cancelled incoming file `%s` of upstream `%s`', file.stream.filename, self.fieldName);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    // If the file is finished, ignore the error.
<span class="cstat-no" title="statement not covered" >    if (file.status === 'finished') {</span>
<span class="cstat-no" title="statement not covered" >      debug('Swallowing fatal upstream error for already-finished incoming file `%s` of upstream `%s`', file.stream.filename, self.fieldName);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    // Mark the file as cancelled
<span class="cstat-no" title="statement not covered" >    file.status = 'cancelled';</span>
&nbsp;
    // Output a debug message indicating that an error occurred on the incoming file.
<span class="cstat-no" title="statement not covered" >    if (!self._connected){</span>
<span class="cstat-no" title="statement not covered" >      debug('Forwarding fatal upstream error for unconnected (i.e. not connected to receiver) incoming file `%s` of upstream `%s`', file.stream.filename, self.fieldName);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      debug('Forwarding fatal upstream error for already-connected (to receiver) incoming file `%s` of upstream `%s`', file.stream.filename, self.fieldName);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    file.stream.emit('error', err);</span>
&nbsp;
  });
&nbsp;
  // Indicate the end of the Upstream (no more files coming)
<span class="cstat-no" title="statement not covered" >  this.noMoreFiles();</span>
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  this._fatalErrors.push(err);</span>
&nbsp;
};
&nbsp;
&nbsp;</pre></td></tr>
