...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-skipper/node_modules/skipper/standalone/Upstream/prototype.writeFile.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-skipper/node_modules/skipper/standalone/Upstream/prototype.writeFile.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-skipper/node_modules/skipper/standalone/Upstream/</a> &#187; prototype.writeFile.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function writeFile (__filestream) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  __filestream.field = __filestream.name;</span>
&nbsp;
  // Track incoming file stream for use in metadata sent back
  // from `.upload()` and also in case we need to cancel it:
<span class="cstat-no" title="statement not covered" >  self._files.push(newFile);</span>
&nbsp;
  // Set up error handler for the new __filestream:
  //
<span class="cstat-no" title="statement not covered" >  __filestream.on('error', (<span class="fstat-no" title="function not covered" >function() {</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var hasFired = false;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          if (!hasFired) {</span>
...
<span class="cstat-no" title="statement not covered" >              __filestream.unpipe();</span>
<span class="cstat-no" title="statement not covered" >              __filestream.pipe(leaky);</span>
<span class="cstat-no" title="statement not covered" >              log('Piping the not-yet-written bytes from incoming file `' + __filestream.filename + '` to the memory hole..');</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          hasFired = true;</span>
      };
&nbsp;
  }()));
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var isBackedUp = !self.push(__filestream);</span>
&nbsp;
  // &lt;PERHAPS?&gt;
  ...
  // &lt;/PERHAPS?&gt;
&nbsp;
<span class="cstat-no" title="statement not covered" >  log.color('grey').write('Upstream: Pumping incoming file through field `%s`', self.fieldName);</span>
&nbsp;
&nbsp;
};
&nbsp;
